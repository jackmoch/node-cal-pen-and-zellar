...
module.exports.renderCal = (dayOfWeek, dateObj) => {
  ...
  let mainHeader = module.exports.centerString(monthString, 20)
...
module.exports.centerString = (string, totalSpaces) => {
  const NUM_LEADING_SPACES = Math.floor((Number(totalSpaces) - string.length) / 2)
